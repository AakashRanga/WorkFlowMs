        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    <li class="nav-item">
                        <a class="nav-link" href="#" id="about-section">About Us</a>
                    </li>
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle" href="#servicesection" id="navbarDropdown" role="button"
                            data-bs-toggle="dropdown" aria-expanded="false" onclick="scrollToSection()">
                            Services
                        </a>
                        ...
                        <ul class="dropdown-menu" aria-labelledby="navbarDropdown3">
                            <div class="research-impact">
                                <div id="service1" class="service-content">
                                    <img src="images/research-impact.png" alt="Research Assistance Image" style="width:300px;height:200px">
                                ...
                                <div id="service2" class="service-content">
                                    <img src="images/sharing-research.png" alt="Sharing Research Work Image" style="width: 300px;
    height: 200px;">
                                ...
                                <div id="service3" class="service-content">
                                    <img src="images/research-blog.png" alt="Writing Research Blogs Image" style="width:300px">
                                ...
                                <div id="service4" class="service-content">
                                    <img src="images/presentation-workshop.png" alt="Presenting Work Image" style="width:300px">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu custom-dropdown-menu" aria-labelledby="navbarDropdown3">
